 ...
 */
export async function validateAgentJurisdiction(
 ...
 */
export async function validateGeographicConsistency(vendor: {
  state?: string;
  district?: string;
  division?: string;
  pincode?: string;
}): Promise<{ consistent: boolean; error?: string; canonicalData?: any }> {
