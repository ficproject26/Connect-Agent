...
// Fallback Leaderboard Data for Demo
const DEMO_LEADERBOARD: LeaderboardItem[] = [
  ...
  },
  {
    _id: 'state-03',
    rank: 3,
    name: 'Ananya Reddy (State Lead)',
    email: 'ananya.r@forge.in',
    phone: '+91 98765 22222',
    registrationId: 'AG-STATE-103',
    role: 'state',
    kycStatus: 'approved',
    registrationFeePaid: true,
    performanceScore: 88,
    weeklyEarnings: 38900,
    targetsCompleted: 8,
    targetsTotal: 10,
    territory: { state: 'Telangana' },
    trend: 'stable'
  },
  ...
  },
  {
    ...
    registrationFeePaid: true,
    performanceScore: 86,
    weeklyEarnings: 26200,
    targetsCompleted: 8,
    targetsTotal: 9,
    territory: { state: 'Tamil Nadu', district: 'Chennai Central' },
    trend: 'up'
  },
  ...
  // DIVISION MANAGERS
  {
    _id: 'div-201',
    rank: 1,
    name: 'Suresh Patil (Division Manager)',
    email: 'suresh.patil@connect.com',
  ...
  },
  {
    _id: 'div-203',
    rank: 2,
    name: 'Arjun Das (Division Manager)',
    ...
    registrationFeePaid: true,
    performanceScore: 89,
    weeklyEarnings: 21800,
    targetsCompleted: 8,
    targetsTotal: 9,
    territory: { state: 'Karnataka', district: 'Mysuru District', division: 'Mysuru City' },
    trend: 'stable'
  },
  {
    _id: 'div-202',
    rank: 3,
    name: 'Meena Rao (Division Lead)',
    ...
    targetsCompleted: 7,
    targetsTotal: 9,
    territory: { state: 'Karnataka', district: 'Bengaluru Urban', division: 'Bengaluru North' },
    trend: 'down'
  },
  ...
  // PINCODE AGENTS
  {
    ...
    registrationFeePaid: true,
    performanceScore: 97,
    weeklyEarnings: 19500,
    targetsCompleted: 10,
    targetsTotal: 10,
    territory: { state: 'Karnataka', district: 'Bengaluru Urban', division: 'Bengaluru North', pincode: '560004' },
    trend: 'up'
  },
  {
    _id: 'pin-306',
    rank: 2,
    name: 'Deepak Gowda (Pincode Agent)',
    ...
    targetsCompleted: 8,
    targetsTotal: 9,
    territory: { state: 'Karnataka', district: 'Mysuru District', division: 'Mysuru City', pincode: '570001' },
    trend: 'up'
  },
  {
    _id: 'pin-301',
    rank: 3,
    name: 'Anil Mehta (Pincode Agent)',
    ...
    targetsCompleted: 7,
    targetsTotal: 8,
    territory: { state: 'Karnataka', district: 'Bengaluru Urban', division: 'Bengaluru South', pincode: '560001' },
    trend: 'stable'
  },
  {
    _id: 'pin-303',
    rank: 4,
    name: 'Venkatesh R (Pincode Agent)',
    ...
    targetsCompleted: 6,
    targetsTotal: 8,
    territory: { state: 'Karnataka', district: 'Bengaluru Urban', division: 'Bengaluru South', pincode: '560003' },
    trend: 'stable'
  }
];
...
export const LeaderboardModule: React.FC = () => {
  ...
  const leaderboardList: LeaderboardItem[] = useMemo(() => {
    let list: LeaderboardItem[] = data?.leaderboard || DEMO_LEADERBOARD;
